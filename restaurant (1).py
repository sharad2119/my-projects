...
txtdisplay = Entry(f2,font=('ariel' ,20,'bold'), textvariable=text_Input , bd=4 ,insertwidth=7 ,bg="white",justify='right')
...
status = Label(f2,font=('aria', 15, 'bold'),width = 16, text="GROUP 8",bd=2,relief=SUNKEN)
...
lblorder = Label(f1, font=( 'aria' ,16, 'bold' ),text="Order No.",fg="steel blue",bd=10,anchor='w')
lblorder.grid(row=0,column=0)
txtorder = Entry(f1,font=('ariel' ,16,'bold'), textvariable=orders, bd=6,insertwidth=4,bg="powder blue" ,justify='right')
